...
<head>
  ...
  <title>Login - Multisite Perangkat Daerah</title>
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('login') }}">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Mohon tulis email dengan benar!</div>
                        @error('email')
                    ...
                    <div class="col-12">
                      ...
                      {{-- <a href="{{ route('admin.dashboard') }}" class="btn btn-primary w-100" type="submit">Login</a> --}}
                    </div>
                    <div class="col-12">
